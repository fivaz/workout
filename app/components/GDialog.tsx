...
export function DialogDescription({
	className,
	...props
}: { className?: string } & Omit<Headless.DescriptionProps<typeof GText>, 'as' | 'className'>) {
	return (
		<Headless.Description as={GText} {...props} className={clsx(className, 'mt-2 text-pretty')} />
	);
}
