...
export function DropdownItem<TTag extends React.ElementType = 'button'>({
	className,
	...props
}: { className?: string } & Headless.MenuItemProps<TTag>) {
	const classes = clsx(
		className,
		// Base styles
	...
	return <Headless.MenuItem {...props} className={classes} />;
}
