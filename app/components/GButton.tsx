...
export default function GButton({
	...
	return (
		<button
			className={clsx(
				'flex gap-2 cursor-pointer justify-center items-center rounded-md px-3 py-1.5 text-sm/6 font-semibold shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 ',
				{
